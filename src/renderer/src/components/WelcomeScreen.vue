...
<template>
  <div class="flex flex-1 flex-col items-center justify-center bg-bg-app gap-8 animate-fade-in">
    <!-- Logo + name -->
    <div class="flex flex-col items-center gap-3">
      <div class="flex h-16 w-16 items-center justify-center rounded-2xl bg-bg-surface border border-border-subtle shadow-lg">
        <svg width="36" height="36" viewBox="0 0 36 36" fill="none" class="text-accent">
          ...
          <path
            d="M8 10h9a5 5 0 0 1 0 10H8V10z"
            stroke="currentColor"
            stroke-width="2.5"
    ...
    <!-- Or start without project -->
    <div class="flex flex-col items-center gap-2">
      <p class="text-xs text-text-disabled">or start without a project</p>
      <p class="text-xs text-text-muted">Code runs with plain PHP — no framework context</p>
    </div>
